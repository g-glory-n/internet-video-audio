...
//	unsigned char *ffmpeg_old_programmer_define_unsigned_char_point__picture_buffer_copy_from_others = NULL;
	...
	ffmpeg_old_programmer_define_unsigned_char_point__picture_buffer_copy_from_others = (unsigned char *)malloc(FFMPEG_PICTURE_WIDTH*FFMPEG_PICTURE_HEIGHT*FFMPEG_PICTURE_BIT_DEPTH);
/*
 * =================================================================================================
...
//	av_register_codec_parser(&ff_h264_parser);
	...
	ffmpeg_old_programmer_define_unsigned_char_point__picture_buffer_after_ffmpeg_old_decode = (unsigned char *)malloc(FFMPEG_PICTURE_WIDTH*FFMPEG_PICTURE_HEIGHT*FFMPEG_PICTURE_BIT_DEPTH);
...
//	av_init_packet(AVPacket_encode__point__packet);
	...
	unsigned long ffmpeg_old_programmer_define_unsigned_long__picture_size = FFMPEG_PICTURE_WIDTH*FFMPEG_PICTURE_HEIGHT*FFMPEG_PICTURE_BIT_DEPTH;
 ...
 * =================================================================================================
*/
	memcpy(ffmpeg_old_programmer_define_unsigned_char_point__picture_buffer_copy_from_others, (unsigned char *)v4l2_programmer_define_struct_point__picture_queue_struct__picture_buffer[v4l2_buffer__dqbuf_qbuf.index].start, V4L2_PICTURE_WIDTH*V4L2_PICTURE_HEIGHT*FFMPEG_PICTURE_BIT_DEPTH);
...
//	AVPacket_decode__point__packet -> size = (signed int)x265_programmer_define_unsigned_long__after_x265_size;
	...
	AVPacket_decode__point__packet -> data = tcp_programmer_define_unsigned_char_point__picture_buffer_in;
	AVPacket_decode__point__packet -> size = (signed int)tcp_programmer_define_unsigned_long__size_of_recv;
	...
	if(ffmpeg_old_programmer_define_signed_int__got_picture)
	{
		...
		switch(AVCodecContext_decode__point__codec_context -> pix_fmt)
		{
			...
			case (AV_PIX_FMT_YUV422P):
			{
				...
				for(ffmpeg_old_index = 0 ; ffmpeg_old_index < (AVFrame_decode__point__frame -> width)*(AVFrame_decode__point__frame -> height)*FFMPEG_PICTURE_BIT_DEPTH; )
				{
