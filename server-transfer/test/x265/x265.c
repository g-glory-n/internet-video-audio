...
//	x265_param__point__param->fpsNum = 25;
//	x265_param__point__param->fpsDenom = 1;
	x265_encoder__point__handle = x265_encoder_open(x265_param__point__param);

	x265_picture__point_in = x265_picture_alloc();
	x265_picture_init(x265_param__point__param, x265_picture__point__in); //?x265_picture_init
	
	x265_programmer_define_unsigned_char_point__picture_Y = x265_picture__point__in->img.plane[0];
	x265_programmer_define_unsigned_char_point__picture_U = x265_picture__point__in->img.plane[1];
	x265_programmer_define_unsigned_char_point__picture_V = x265_picture__point__in->img.plane[2];
}
...
void x265_picture_encode(void)
{
	...
	unsigned long x265_programmer_define_unsigned_long__picture_size = X264_PICTURE_WIDTH*X264_PICTURE_HEIGHT*2;
...
////	x265_picture__point__in->type = X264_TYPE_AUTO; //?X264_TYPE_AUTO
...
*/
	...
	{
		memcpy(x265_programmer_define_unsigned_char_point__picture_buffer, x265_nal__point__nal[x265_programmer_define_unsigned_long__for_i1].payload, x265_nal__point__nal[x265_programmer_define_unsigned_long__for_i1].sizeBytes);   
...
*/
	...
	{ 
		...
		{
			memcpy(x265_programmer_define_unsigned_char_point__picture_buffer, x265_nal__point__nal[x265_programmer_define_unsigned_long__for_i0].payload, x265_nal__point__nal[x265_programmer_define_unsigned_long__for_i0].sizeBytes);   
